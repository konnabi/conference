...
import conference.config.audit.AuditEventConverter;
import conference.domain.PersistentAuditEvent;
...
import static conference.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
